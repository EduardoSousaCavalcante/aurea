                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date"
                               ...
                               value="{{ old('data_entrega', optional($pedido->data_entrega)->format('Y-m-d')) }}">
                        @error('data_entrega')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="metodo_pagamento"
                                id="metodo_pagamento"
                                class="form-control @error('metodo_pagamento') is-invalid @enderror">

                            <option value="">Selecione</option>

                            <option value="pix"
                                {{ old('metodo_pagamento', $pedido->metodo_pagamento) == 'pix' ? 'selected' : '' }}>
                                Pix
                            </option>

                            <option value="boleto"
                                {{ old('metodo_pagamento', $pedido->metodo_pagamento) == 'boleto' ? 'selected' : '' }}>
                                Boleto
                            </option>

                            <option value="cartao"
                                {{ old('metodo_pagamento', $pedido->metodo_pagamento) == 'cartao' ? 'selected' : '' }}>
                                Cartão
                            </option>

                            <option value="dinheiro"
                                {{ old('metodo_pagamento', $pedido->metodo_pagamento) == 'dinheiro' ? 'selected' : '' }}>
                                Dinheiro
                            </option>
